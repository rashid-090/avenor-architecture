      ...
      <div className="w-[95%] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col justify-center order-2 lg:order-1">
            <h2 className="about-heading text-zinc-900 text-3xl md:text-[34px] lg:text-[40px] font-normal leading-[1.25] tracking-tight mb-8">
            Our services
            </h2>
            <p className="about-body text-zinc-500 text-sm md:text-[15px] font-light leading-relaxed max-w-lg">
             We design inspiring spaces that blend creativity, functionality, and sustainability. Every project is thoughtfully planned to reflect your vision while meeting practical needs, ensuring a seamless balance between aesthetics and performance.
            </p>
          </div>
